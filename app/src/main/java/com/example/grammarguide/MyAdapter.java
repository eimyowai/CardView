...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ArtViewHolder> {
    ...
    public MyAdapter(Context mCtx, List<Art> artistList) {
        this.mCtx = mCtx;
    ...
    public ArtViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mCtx).inflate(R.layout.menu_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull ArtViewHolder holder, int position) {
        ...
        holder.r3.setText(art.getRadio3());
        holder.r4.setText(art.getRadio4());
    }
