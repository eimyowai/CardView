...
public class Question2 extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent ii=new Intent(getApplicationContext(),Question2.class);
    ...
    public void showResult(){
        ...
        retry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Question2.this, Lesson2.class);
        ...
        level.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Question2.this,AdvancedActivity.class);
        ...
        if (MyAdapter2.countDownTimer == null) {
            MyAdapter2.countDownTimer = new CountDownTimer(MyAdapter2.TOTAL_TIME, 1000) {
                ...
                public void onFinish() {
                    ...
                    Intent inte=new Intent(Question2.this,AdvancedActivity.class);
                    startActivity(inte);
                }
            }.start();
        } else {
