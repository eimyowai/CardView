...
ImageView face;
    ...
    public void onClick(View view) {
        Intent ii=new Intent(getApplicationContext(),Question.class);
...
public void showResult(){
    ...
    retry.setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            Intent intent=new Intent(Question.this,ArticleLessonActivity.class);
    ...
    level.setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            Intent intent=new Intent(Question.this,BasicActivity.class);
        ...
        if (MyAdapter.countDownTimer == null) {
            MyAdapter.countDownTimer = new CountDownTimer(MyAdapter.TOTAL_TIME, 1000) {
                ...
                public void onFinish() {
                    ...
                    Intent inte=new Intent(Question.this,BasicActivity.class);
                    startActivity(inte);
                }
            }.start();
        } else {
